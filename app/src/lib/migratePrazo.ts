...
import { normalizeDemandaPrazo, normalizeOrdemPrazo } from '@/lib/prazoStatus';

/** Prazos canônicos do seed demo — corrige registros legados com datas futuras (jun/2026). */
