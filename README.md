...
Copie `app/.env.example` → `app/.env` (`VITE_API_URL=http://127.0.0.1:8790`). Detalhes: [docs/PRODUCAO.md](docs/PRODUCAO.md) · PostGIS/JWT/fotos: [docs/FASE3.md](docs/FASE3.md) · Fotos offline + Render: [docs/FASE4.md](docs/FASE4.md) · API na nuvem: [docs/HOSPEDAR-API.md](docs/HOSPEDAR-API.md)
